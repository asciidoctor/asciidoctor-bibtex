...
- formatting of references and reference list in choice of:
  - author-date style, after 'The Chicago Manual of Style' or 'Harvard'
  - numeric style
...
Examples of author-year (Chicago) style:
...
Command-line options:
 ...
 > asciidoc-bib -h
    Usage: asciidoc-bib filename
        ...
        -s, --style STYLE                style for references

STYLE can take values:

- _authoryear_ Chicage style author-year, the default.
- _authoryear:chicago_ Chicage style author-year.
- _authoryear:harvard_ Chicage style author-year, the default.
