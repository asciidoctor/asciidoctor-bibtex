...
- formatting of references and reference list according to range of styles supported by [citeproc-ruby](http://github.com/inukshuk/citeproc-ruby)
...
(Ensure 'ruby-dev' is installed, so the dependencies will compile.)
...
[Michel Krämer](https://github.com/michel-kraemer) provided the code linking to
citeproc.
