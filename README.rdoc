...
- formatting of references and reference list in choice of:
	...
	. author-date style after 'The Chicago Manual of Style'
	. numeric style after Springer LNCS
...
authoryear:: Chicage style author-year, the default.
numeric:: Springer LNCS style numeric.
